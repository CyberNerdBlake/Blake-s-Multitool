...
dex.geometry("400x300")
dex.iconbitmap("C:\\Users\\Kmuwl\\Downloads\\Chemical.ico")
...
photo = PhotoImage(file = "assets/background.png")

img.create_image(-150,0,anchor ="nw",image = photo)
